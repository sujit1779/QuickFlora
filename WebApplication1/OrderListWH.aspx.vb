...
Partial Class OrderList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            BindOrderHeaderList()
        Else
            Dim ty As Type = e.GetType()

            Page.ClientScript.RegisterStartupScript(ty, "ReloadDatePicker", "Search.init();", True)
        End If
    ...
    Protected Sub cmblocationid_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmblocationid.SelectedIndexChanged, drpstatus.SelectedIndexChanged, drpOccasionCode.SelectedIndexChanged
        BindOrderHeaderList()
    End Sub
    ...
    Private Sub OrderHeaderGrid_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles OrderHeaderGrid.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            End If
            If drpProductFamily.SelectedValue <> "" Or txtitemsearch.Text <> "" Then
            ...
            Dim lable1 As Label
            lable1 = e.Row.FindControl("Label1")
            Try
                'lable1.Text = lblOrderNumber.Text

                Dim dt4 As New DataSet
                dt4 = GetFinalize(lblOrderNumber.Text)
    ...
    Public Function GetFinalize(ByVal po As String) As DataSet

        Using connection As New SqlConnection(ConfigurationManager.AppSettings("ConnectionString"))
            Using Command As New SqlCommand("Select PurchaseNumber from PurchaseOrderFinalize where CompanyID = @CompanyID and DivisionID = @DivisionID and DepartmentID = @DepartmentID and PurchaseNumber = @po", connection)
                Command.CommandType = CommandType.Text

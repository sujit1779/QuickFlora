...
Partial Class InventoryForm
    ...
    Public Function GetInventoryItemsListNew() As DataSet
        ...
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("ConnectionString"))
            Using Command As New SqlCommand("[enterprise].[GetInventoryItemsListAvailbilityBetaNewPage1]", connection)
                ...
                Command.Parameters.AddWithValue("@Committed", chkrequested.Checked)
                '@Committed
                Session("p1") = cmblocationid.SelectedValue
                Session("p2") = drpSearchCondition.SelectedValue
                Session("p3") = drpSearchFor.SelectedValue
                Session("p4") = txtSearchValue.Text
                Session("p5") = txtDateTo.Text
                Session("p6") = txtstart.Text
                Session("p7") = txtend.Text
                Session("p8") = chkrequested.Checked
    ...
    Protected Sub gvItemsList_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvItemsList.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim lblstartavailabledate As Label = e.Row.FindControl("lblstartavailabledate")
            Dim lblendavailabledate As Label = e.Row.FindControl("lblendavailabledate")


            Try
                If lblstartavailabledate.Text = "1/1/1900 12:00:00 AM" Then
                    lblstartavailabledate.Text = ""
                Else
                    Dim startdate As DateTime
                    Try
                        startdate = lblstartavailabledate.Text
                        lblstartavailabledate.Text = startdate.ToShortDateString
                    Catch ex As Exception
            ...
            Try
                If lblendavailabledate.Text = "1/1/1900 12:00:00 AM" Then
                    lblendavailabledate.Text = ""
                Else
                    Dim enddate As DateTime
                    Try
                        enddate = lblendavailabledate.Text
                        lblendavailabledate.Text = enddate.ToShortDateString
                    Catch ex As Exception
            ...
            End Try
            Dim txtstem As TextBox = e.Row.FindControl("txtstem")
            Dim txtprice As TextBox = e.Row.FindControl("txtprice")
            txtstem.Attributes.Add("onKeyUp", "allnumeric(this)")
            txtprice.Attributes.Add("onKeyUp", "allnumeric2(this)")

            txtstem.Attributes.Add("onfocus", "myFocusFunction(this)")
            txtstem.Attributes.Add("onblur", "Saveitem(this,'" & txtItemID.Text & "','QtyOnHand','" & txtstem.Text & "')")

...
Partial Class InvitationtoBid
    ...
    Public Function GetInventoryItemsListNew() As DataSet
        ...
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("ConnectionString"))
            Using Command As New SqlCommand("[enterprise].[GetRequisitionBidAccept]", connection)
                ...
                Command.Parameters.AddWithValue("@vendorID", cmblocationid.SelectedValue)

<%@ Page Title="" ValidateRequest="false" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false" CodeFile="emailMT.aspx.vb" Inherits="emailMT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    Preview and send Inventory Transfer mail
...
<table border="0" class="table table-bordered table-striped table-condensed flip-content"  runat="server"   id="table1">               
        ...
        <tr>
            ...
            <td width="560" style="padding:5px; border-style:solid; border-width:thin; border-color:Gray; "  >
              Add Comments: <br />
                 <asp:TextBox ID="txtEmailContent"  Columns="50" Rows="8"  TextMode="MultiLine"  CssClass="form-control" runat="server"></asp:TextBox>
                 <br />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RequestReportB.aspx.vb" MasterPageFile="~/MainMaster.master"  Inherits="RequestReportB" %>
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
                        ...
                        <tr>
                            ...
                            &nbsp;
                               ...
                               <div style=" text-align:center; width:75%;">
                                 &nbsp;&nbsp; <asp:RadioButton ID="optallstatus" AutoPostBack="true"  Visible="false"   Text="&nbsp;All Status" GroupName="status"   runat="server" /> &nbsp; 
                                 <asp:RadioButton ID="optBought" Text="&nbsp;Bought"  Checked="true"  Visible="false" AutoPostBack="true"   GroupName="status"   runat="server" />
    ...
    <div>
        ...
        <table cellpadding=0 cellspacing=0 style="width:100%;">
           ...
           <asp:GridView ID="rptorderlist" AllowSorting="True" runat="server"   CssClass="table table-bordered table-striped table-condensed flip-content"     AutoGenerateColumns="false" AllowPaging="True" PageSize="25">
           ...
           <Columns>
                ...
                <asp:TemplateField HeaderText="Ext. COSt"  >
                 ...
                 <asp:TemplateField HeaderText="Location"  >
                    ...
                    <table cellspacing="1" cellpadding="1" border="0"  runat="server" visible="false"  id="Table2" style="color: Black;    background-color: White; width: 100%;">
                            <tr  >
                 ...
                 <asp:Repeater runat="server"   ID="Xyz">
                            <ItemTemplate>

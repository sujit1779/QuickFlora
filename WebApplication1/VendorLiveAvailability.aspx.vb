...
Partial Class VendorLiveAvailability
    ...
    Private Sub gvItemsList_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvItemsList.RowCommand
    ...
    Private Sub gvItemsList_RowEditing(ByVal sender As Object, ByVal e As GridViewEditEventArgs) Handles gvItemsList.RowEditing
    ...
    Private Sub InventoryFormAdd_PreRender(ByVal sender As Object, ByVal e As EventArgs) Handles Me.PreRender

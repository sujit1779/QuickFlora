...
Partial Class POEXPERTEXCEL
    ...
    Private Sub ExportExcelROL_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        ssql = "[dbo].[POExcelImportReportNewBeta]"
        ...
        com.Parameters.Add(New SqlParameter("@fromDate", SqlDbType.NVarChar, 36)).Value = Session("txtDeliveryDate")
        com.Parameters.Add(New SqlParameter("@todate", SqlDbType.NVarChar, 36)).Value = Session("txtDeliveryDateTO")
        com.Parameters.Add(New SqlParameter("@VendorCode", SqlDbType.NVarChar, 36)).Value = Session("cmblocationid")
        com.Parameters.Add(New SqlParameter("@ProductVendorCode", SqlDbType.NVarChar, 36)).Value = Session("ProductVendorCode")
        ...
        If dt.Rows.Count <> 0 Then
            ...
            Response.AddHeader("content-disposition", String.Format("attachment; filename={0}", "POToVendor.xls"))

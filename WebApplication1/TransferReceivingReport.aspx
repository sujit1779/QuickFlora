<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false" CodeFile="TransferReceivingReport.aspx.vb" Inherits="TransferReceivingReport" %>
                            ...
                            <td style="height: 40px" colspan="3" align="left">
                                ...
                                <asp:TextBox ID="txtDeliveryDateTO"     runat="server" Width="101px"></asp:TextBox>&nbsp;
                                 ...
                                 &nbsp;&nbsp; 
                                   ...
                                   &nbsp;&nbsp;  
                                   <asp:RadioButton ID="optbyArriveDate" Text="&nbsp;By Transfer Date"    AutoPostBack="true"   GroupName="status"   runat="server" />

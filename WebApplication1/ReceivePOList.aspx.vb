...
Partial Class ReceivePOList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If CompanyID.ToUpper = "JWF" Or CompanyID.ToUpper = "NEWWF" Then
            Response.Redirect("ReceivePOListJWF.aspx")
        End If
    ...
    Protected Sub cmblocationid_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmblocationid.SelectedIndexChanged, drpstatus.SelectedIndexChanged, drpvendor.SelectedIndexChanged
        BindOrderHeaderList()
    End Sub

...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not Request.QueryString("k") = Nothing Then
            ...
            Dim txtUOMVL As String = ""
            Try
                txtUOM = Request.QueryString("txtUOM")
            Catch ex As Exception

            End Try

            Dim txtWHOPrice As String = ""
            Dim txtWHOPriceVL As String = ""
            Try
                txtWHOPrice = Request.QueryString("txtWHOPrice")
            Catch ex As Exception
            ...
            If keyword <> "" Then
                ...
                If dt.Rows.Count <> 0 Then
                    ...
                    For Each row As DataRow In dt.Rows
                        ...
                        If CustomerTypeID = "WHO" Or CustomerTypeID = "WHOC" Or CompanyID = "QuickfloraDemo" Then
                            Try
                        ...
                        If CompanyID = "QuickfloraDemo" Or True Then
                            Dim up As Double = 0
                            up = row("wholesalePrice").ToString()
                            txtWHOPriceVL = Format(up, "0.00")
                        End If
                        ...
                        str = str & "<td align='left'><a  href=" + """" + "javascript:FillSearchtextBoxnew('" + row("ItemID").ToString().Replace("'", "") + "','" + id + "','" + RowNumber + "','" + UnitPrice.ToString + "','" + UnitsPerBox.ToString + "','" + txtCOST_ClientID + "','" + txtPACK_ClientID + "','" & ItemNameOk & "','" & VendorID & "','" & txtVendor_Code & "','" & txtUOM & "','" & txtUOMVL & "','" & txtWHOPrice & "','" & txtWHOPriceVL & "')" + """" + " ><strong>" + ItemID + "</strong> </a></td>"

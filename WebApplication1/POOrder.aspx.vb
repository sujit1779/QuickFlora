...
Partial Class PO
    ...
    Public Function OrderHeaderDeliveryMethods123(ByVal OrderNumber As String) As DataTable
        Dim dt As New DataTable
        Dim constr As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim connec As New SqlConnection(constr)
        Dim qry As String
        qry = " Select  *  from   [PODeliveryMethods123] Where CompanyID=@f1  AND   DivisionID =@f2  AND  DepartmentID =@f3  AND [OrderNumber]=@f4   "
    ...
    Public Sub BindCustomerDetails(ByVal PurchaseOrderNumber As String)
        ...
        Dim dtdrpShipMethod1 As New DataTable
        dtdrpShipMethod1 = OrderHeaderDeliveryMethods123(PurchaseOrderNumber)
        If dtdrpShipMethod1.Rows.Count > 0 Then

            Try
                drpShipMethod1.SelectedValue = dtdrpShipMethod1.Rows(0)("ShipMethodID1")
                drpShipMethod2.SelectedValue = dtdrpShipMethod1.Rows(0)("ShipMethodID2")
                drpShipMethod3.SelectedValue = dtdrpShipMethod1.Rows(0)("ShipMethodID3")
    ...
    Public Sub PopulateDeliveryMethods1()
        ...
        Dim PopOrderType As New CustomOrder()
        Dim rs As SqlDataReader
        rs = PopulateDeliveryMethodsother1(CompanyID, DepartmentID, DivisionID)

        drpShipMethod1.DataTextField = "ShipMethodDescription"
        drpShipMethod1.DataValueField = "ShipMethodID"
        drpShipMethod1.DataSource = rs
        drpShipMethod1.DataBind()
        drpShipMethod1.Items.Insert(0, (New ListItem("-Select-", "0")))
    ...
    Public Sub PopulateDeliveryMethods2()
        'Dim filters As EnterpriseCommon.Core.FilterSet
        'filters = CType(Session("SessionFilters"), EnterpriseCommon.Core.FilterSet)
        'CompanyID = filters!CompanyID
        'DivisionID = filters!DivisionID
        ...
        Dim PopOrderType As New CustomOrder()
        Dim rs As SqlDataReader
        rs = PopulateDeliveryMethodsother2(CompanyID, DepartmentID, DivisionID)

        drpShipMethod2.DataTextField = "ShipMethodDescription"
        drpShipMethod2.DataValueField = "ShipMethodID"
        drpShipMethod2.DataSource = rs
        drpShipMethod2.DataBind()
        drpShipMethod2.Items.Insert(0, (New ListItem("-Select-", "0")))
    ...
    Public Sub PopulateDeliveryMethods3()
        'Dim filters As EnterpriseCommon.Core.FilterSet
        'filters = CType(Session("SessionFilters"), EnterpriseCommon.Core.FilterSet)
        'CompanyID = filters!CompanyID
        'DivisionID = filters!DivisionID
        ...
        Dim PopOrderType As New CustomOrder()
        Dim rs As SqlDataReader
        rs = PopulateDeliveryMethodsother3(CompanyID, DepartmentID, DivisionID)

        drpShipMethod3.DataTextField = "ShipMethodDescription"
        drpShipMethod3.DataValueField = "ShipMethodID"
        drpShipMethod3.DataSource = rs
        drpShipMethod3.DataBind()
        drpShipMethod3.Items.Insert(0, (New ListItem("-Select-", "0")))

        Try
            ' drpShipMethod3.SelectedValue = drpShipMethod3.Items.IndexOf(drpShipMethod3.Items.FindByText("0"))
    ...
    Public Function PopulateDeliveryMethodsother1(ByVal CompanyID As String, ByVal DepartmentID As String, ByVal DivisionID As String) As SqlDataReader

        Dim ConString As New SqlConnection(ConfigurationManager.AppSettings("ConnectionString"))
        ConString.Open()
        Dim myCommand As New SqlCommand("PopulateDeliveryMethods1", ConString)
        myCommand.CommandType = Data.CommandType.StoredProcedure
    ...
    Public Function PopulateDeliveryMethodsother2(ByVal CompanyID As String, ByVal DepartmentID As String, ByVal DivisionID As String) As SqlDataReader

        Dim ConString As New SqlConnection(ConfigurationManager.AppSettings("ConnectionString"))
        ConString.Open()
        Dim myCommand As New SqlCommand("PopulateDeliveryMethods2", ConString)
        myCommand.CommandType = Data.CommandType.StoredProcedure
    ...
    Public Function PopulateDeliveryMethodsother3(ByVal CompanyID As String, ByVal DepartmentID As String, ByVal DivisionID As String) As SqlDataReader

        Dim ConString As New SqlConnection(ConfigurationManager.AppSettings("ConnectionString"))
        ConString.Open()
        Dim myCommand As New SqlCommand("PopulateDeliveryMethods3", ConString)
        myCommand.CommandType = Data.CommandType.StoredProcedure
    ...
    Public Sub PopulateDrops()
        ...
        EmployeeID = Session("EmployeeID")
        Try
            PopulateDeliveryMethods1()
            PopulateDeliveryMethods2()
            PopulateDeliveryMethods3()

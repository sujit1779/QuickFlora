<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false" CodeFile="POExporttoExcel.aspx.vb" Inherits="POExporttoExcel" %>
			          ...
			          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td style="height: 40px" colspan="3" align="left">
                                <asp:Label ID="lbReportdate" runat="server" Text='Date : ' CssClass="font11_blue_black_padding" />
                                ...
                                <asp:TextBox ID="txtDeliveryDateTO"  Visible="false"  runat="server" Width="101px"></asp:TextBox>&nbsp;
                                 ...
                                 &nbsp;&nbsp; 
                                   <asp:RadioButton ID="optbyShipDate" Checked="true" AutoPostBack="true"    Text="&nbsp;By Ship Date" GroupName="status"   runat="server" />
                                   &nbsp;&nbsp;  
                                   <asp:RadioButton ID="optbyArriveDate" Text="&nbsp;By Arrive Date"  AutoPostBack="true"   GroupName="status"   runat="server" />
                        ...
                        <tr>
                            <td align="left" colspan="3">
                              ...
                              PO  Vendor
                                ...
                                &nbsp;
                             Product Vendor
                            <asp:DropDownList ID="drpProductVendor"    runat="server" AppendDataBoundItems="true" AutoPostBack="true">
    ...
    <div>
        ...
        <table cellpadding=0 cellspacing=0 style="width:100%;">
            <tr>
                ...
                <td style="width:25%; text-align:center;" ><h3><u> PO to Vendor </u> </h3> </td>
                <td style="width:25%; text-align:right; padding-right:30px;" >&nbsp; <a href="#" onClick="window.open('POEXPERTEXCEL.aspx','gotFusion','toolbar=1,location=1,directories=0,status=0,menubar=1,scrollbars=1,resizable=1,copyhistory=0,width=800,height=600,left=0,top=0')" ><img  alt="excel" src="https://secure.quickflora.com/images/excel.png" width="50" height="50" border="0" /></a>  </td>

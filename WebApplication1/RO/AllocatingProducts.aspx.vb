...
Partial Class RO_AllocatingProducts
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("PreBookID") <> "" Then
            Session("PreBookID") = Request.QueryString("PreBookID")
        Else
            Response.Redirect("PreBookItems.aspx")
        End If

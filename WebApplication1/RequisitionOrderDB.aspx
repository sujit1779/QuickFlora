<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="RequisitionOrderDB.aspx.vb" Inherits="RequisitionOrderDB" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SetStatusColorforblank(This) {
           // alert('Hi');
            
            if (This.value == "") {
              //  alert(This.value);
                This.style.backgroundColor = "#FFA8A8";
            ...
            SetStatusColorforblankdate();
           
        }

        function SetStatusColorforblankdate() {
            //alert(document.getElementById('<%=txtarrivedate.ClientID%>').value);
             if (document.getElementById('<%=txtarrivedate.ClientID%>').value == "") {
              //  alert(This.value);
                document.getElementById('<%=txtarrivedate.ClientID%>').style.backgroundColor = "#FFA8A8";
            }
            else {
              //  alert(This.value);
                document.getElementById('<%=txtarrivedate.ClientID%>').style.backgroundColor = "#ffffff";
            }
            
             if (document.getElementById('<%=txtshipdate.ClientID%>').value == "") {
              //  alert(This.value);
                document.getElementById('<%=txtshipdate.ClientID%>').style.backgroundColor = "#FFA8A8";
            }
            else {
              //  alert(This.value);
                document.getElementById('<%=txtshipdate.ClientID%>').style.backgroundColor = "#ffffff";
            }
        }

         function SetStatusColorforblankdate1() {
             document.getElementById('<%=txtarrivedate.ClientID%>').style.backgroundColor = "#ffffff";
        }
         function SetStatusColorforblankdate2() {
           document.getElementById('<%=txtshipdate.ClientID%>').style.backgroundColor = "#ffffff";
        }
        var req;
        ...
        function SetStatusColor(status, RowNumber) {
         ...
         function Saveitemandcopy(This, RowNumber, name, oldvalue,copyid) {
            Initialize();
            This.style.backgroundColor = "";
             var url = "AjaxPOSave.aspx?RowNumber=" + RowNumber + "&value=" + This.value + "&name=" + name;
              document.getElementById(copyid).value = This.value;
            if (name == "Status") {
        ...
        function Saveitemnew(id0, RowNumber, name, oldvalue) {
            ...
            var url = "AjaxPOSave.aspx?RowNumber=" + RowNumber + "&value=" + document.getElementById(id0).value + "&name=" + name;
            // alert(url);
...
//                return 0;
 ...
 //myFocusFunctiontotalnewqreq(key,RowNumber, id2, id3)
        function ItemNamesearch(id1,RowNumber, id2, id3, id4) {
            ...
            var url = "AjaxItemsSearchNameImg.aspx?k=" + key;
           // alert(url);
            ...
            $.get(url, function(data, status) {
                ...
                if (str1[0] != "Not Found") {
                    ...
                    document.getElementById(id1 + "img").innerHTML = "";
                    document.getElementById(id1 + "img").appendChild(img); 
                    //alert(id2);
...
//                return 0;
        ...
        function SendQuery2(key, This, RowNumber, txtPACK_ClientID, txtCOST_ClientID, txtVendor_Code) {
            //alert(This.id);
            //alert(RowNumber);
            ...
            Initialize();
            var url = "AjaxItemsSearchNew.aspx?k=" + key + "&id=" + This.id + "&RowNumber=" + RowNumber + "&txtPACK_ClientID=" + txtPACK_ClientID + "&txtCOST_ClientID=" + txtCOST_ClientID + "&txtVendor_Code=" + txtVendor_Code;
            // alert(url);
        ...
        function FillSearchtextBoxnew(val, ID, DIVID, val1, val2, id1, id2, nm, VendorID , txtVendor_Code) {
            // alert(val);
            document.getElementById(ID).value = val;
            ...
            document.getElementById(txtVendor_Code).value = VendorID;
            document.getElementById("autocomplete" + DIVID).innerHTML = "";
            document.getElementById(ID).focus();
            document.getElementById(ID).click();
            HideDiv("autocomplete" + DIVID);
            ...
            <div class="portlet-body">
                <div class="row">
                    <div class="col-xs-12" style="text-align:left;">
                        <asp:Label ID="lblmasterlocation" runat="server" Visible="false"  Text=""></asp:Label>
                    </div> 
                </div> 
                ...
                <div class="note note-success margin-bottom-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            ...
                            Inventory Origin 
                            <asp:DropDownList ID="drpInventoryOrigin" CssClass="form-control input-sm" runat="server" AppendDataBoundItems="true" AutoPostBack="true">
                        ...
                        <div class="col-xs-3">
                            ...
                            Ship Method:
                              <asp:DropDownList ID="drpshipemthod" CssClass="form-control input-sm" runat="server" AppendDataBoundItems="true" AutoPostBack="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            Type:
                              <asp:DropDownList ID="drpType" CssClass="form-control input-sm" runat="server" AppendDataBoundItems="true" AutoPostBack="true">
            ...
            <div class="portlet-body">
                <div class="row">
                    <div style="text-align: left; padding-bottom:10px;" class="col-xs-12">
                          <asp:Button CssClass="btn btn-success btn-xs" ID="btnaddnew" runat="server" Text="Add New" />
                        &nbsp;&nbsp;<asp:Button CssClass="btn btn-warning btn-xs" ID="btnDelete" runat="server" Text="Delete" />
                        &nbsp;&nbsp;<asp:Button CssClass="btn btn-success btn-xs" ID="btnLoadProductList" runat="server" Text="Load Product List" />  
                        ...
                        &nbsp;&nbsp;<a onClick="window.open('ExportExcelROItems.aspx?OrderNo=' + document.getElementById('ctl00_ContentPlaceHolder_txtoderno').value,'gotFusion','toolbar=1,location=1,directories=0,status=0,menubar=1,scrollbars=1,resizable=1,copyhistory=0,width=800,height=600,left=0,top=0')" href="#" ><img  alt="excel" src="https://secure.quickflora.com/images/excel.png" width="75" height="75" border="0" /></a>
                ...
                <asp:GridView ID="OrderHeaderGrid" ShowHeaderWhenEmpty="true" AllowSorting="True" runat="server" DataKeyNames="InLineNumber" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="false" AllowPaging="True" PageSize="500">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Product">
                           ...
                           <asp:TemplateField HeaderText="Thumb">
                            <ItemTemplate>
                                <asp:Label ID="txtProductimg" Text=''  runat="server"></asp:Label>
                            </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="From Req."   >
                    <ItemTemplate>
                        <asp:Label ID="lblfromreq" Text='<%#Eval("FromReq")%>' runat="server"></asp:Label>
                        
                    </ItemTemplate>
                </asp:TemplateField>

                 <asp:TemplateField HeaderText="To Req."   >
                    <ItemTemplate>
                        <asp:Label ID="lbltoreq" Text='<%#Eval("ToReq")%>' runat="server"></asp:Label>
                ...
                <div class="row">
                    <div style="text-align: center; padding-top:10px;" class="col-xs-12">
                       <asp:Button ID="btnrecalculate" CssClass="btn btn-success btn-xs" runat="server" Text="Re Calculate" />&nbsp;&nbsp;<asp:Button ID="btnsavechanges" CssClass="btn btn-success btn-xs" runat="server" Text=" Save Changes" />&nbsp;&nbsp; <asp:Button ID="btnsave"  OnClientClick="return validateForm();" CssClass="btn btn-success btn-xs" runat="server" Text=" Submit " />&nbsp;&nbsp;<asp:Button CssClass="btn btn-warning btn-xs" ID="btnclose" runat="server" Text="Close" />
                    </div>
                </div>
    ...
    <script type="text/javascript" >
        ...
        function doOnLoad() {
            ...
            if (<%=onloadcalnder%> == "1") {
                ...
                myCalendar4.setSensitiveRange("6/15/2020", null);
                myCalendar4.attachEvent('onClick', function(){SetStatusColorforblankdate1();});

                 myCalendar40 = new dhtmlXCalendarObject(["<%=txtshipdate.ClientID%>"]);
                 myCalendar40.setDateFormat("%m/%d/%Y");
                myCalendar40.setSensitiveRange("6/15/2020", null);
                myCalendar40.attachEvent('onClick', function(){SetStatusColorforblankdate2();});

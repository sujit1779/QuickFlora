...
Public Class clsCustomerInformation_RetailCustomer
    ...
    Public Function InsertCustomerInformationDetail() As Boolean
        ...
        Dim qry As String
        qry = "INSERT INTO  CustomerInformation_RetailCustomer (CompanyID, DivisionID, DepartmentID,OrderNumber, CustomerID, AccountStatus" _
        ...
        & ",CustomerCell, CustomerPhoneExt,CustomerCompany, Newsletter) values(@f1,@f2,@f3,@f33,@f4,@f5,@f6,@f7,@f8,@f9,@f10,@f11,@f12,@f13,@f14,@f15,@f16,@f17,@f18,@f19,@f20,@f21,@f22,@f23,@f24,@f25,@f26,@f27,@f28)"
        ...
        Try
            ...
            com.Parameters.Add(New SqlParameter("@f33", SqlDbType.NVarChar, 36)).Value = Me.OrderNumber.Trim
    ...
    Public Function DeleteCustomerInformationDetail() As Boolean

        Dim connec As New SqlConnection(constr)
        Dim qry As String
        qry = "DELETE FROM   CustomerInformation_RetailCustomer Where CompanyID=@f1  AND   DivisionID =@f2  AND  DepartmentID =@f3  AND OrderNumber=@f4"
    ...
    Public Function SelectCustomerInformationDetail() As DataTable
        Dim dt As New DataTable

        Dim connec As New SqlConnection(constr)
        Dim qry As String
        qry = "Select * from   CustomerInformation_RetailCustomer Where CompanyID=@f1  AND   DivisionID =@f2  AND  DepartmentID =@f3  AND OrderNumber=@f4"

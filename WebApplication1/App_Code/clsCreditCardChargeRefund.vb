...
Public Class clsCreditCardChargeRefund
    ...
    Public Function RefundCreditCardCHarge() As String
        ...
        Dim frommail As String = "gaurav@quickflora.com"
        Dim tomail As String = "gaurav@quickflora.com"
    ...
    Public Function RefundChrageCreditCard() As String
        ...
        If CreditCardOffline = False Then
            ...
            If dt.Rows.Count <> 0 Then
                ...
                obj_mail.ErrorMailHandling("Refund process last step ", OrderNumber, lblerrormessag.Text)
    ...
    Public Function PaymentMercuryDetailsRefundBeforeAditionalcharge(ByVal OrdNumber As String, ByVal dtpayment As DataTable) As String
        ...
        If chkDay Then
            ...
            lblerrormessag.Text = lblerrormessag.Text & "Same Day Cancel Process not allowed"
        ...
        If MercuryData.CMDStatus = "Approved" Then
            ...
            ApprovalNumber = MercuryData.Response_RefNo
            ...
            objclsPaymentGatewayTransactionLogs.PPIOrderID = ApprovalNumber ' MercuryData.Response_RefNo
    ...
    Public Function PaymentAuthorizeNetDetailsRefundBeforeAditionalcharge(ByVal OrdNumber As String, ByVal dtpayment As DataTable) As String
        ...
        If response_obj.Approved = True Then
            ...
            ApprovalNumber = response_obj.TransactionID
    ...
    Public Function PaymentMecrhantWareDetailsRefundBeforeAditionalcharge(ByVal OrdNumber As String, ByVal dtpayment As DataTable) As String
        ...
        If StatusInfo2.ApprovalStatus = "APPROVED" Then
            ...
            ApprovalNumber = StatusInfo2.AuthCode

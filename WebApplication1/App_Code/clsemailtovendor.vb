...
Public Class clsemailtovendor
    ...
    Public txtfrom As New TextBox
    Public txtto As New TextBox
    Public txtvendorid As New TextBox
    Public txtcc As New TextBox
    Public txtcc2 As New TextBox
    Public txtemailsubject As New TextBox
    Public txtEmailContent As New TextBox
    Public divEmailContent As New TextBox
    ...
    Public Sub PopulateEmailForVendors(ByVal EmailType As String, ByVal EmailContent As String, ByVal EmailSubject As String, ByVal PurchaseOrderNumber As String, ByVal vendoremail As String)
        ...
        'strlink = "<a  target='_blank'  href='https://reports.quickflora.com/reports/scripts/POReport.aspx?CompanyID=" & Me.CompanyID & "&DivisionID=" & Me.DivisionID & "&DepartmentID=" & Me.DepartmentID & "&PurchaseNumber=" & PurchaseOrderNumber & "' >Click to Open PDF</a>"

        'EmailContent = EmailContent.Replace("~link~", strlink)

        strlink = "<a  target='_blank'  href='https://secure.quickflora.com/Admin/scripts/AcknowledgementUpdateThanks.aspx?CompanyID=" & Me.CompanyID & "&DivisionID=" & Me.DivisionID & "&DepartmentID=" & Me.DepartmentID & "&PurchaseNumber=" & PurchaseOrderNumber & "' >Click to Acknowledgement Update </a>"

        EmailContent = EmailContent.Replace("~linkack~", strlink)
        'linkack
        ...
        divEmailContent.Text = OrderPlacedContent
    ...
    Public Function GetPO_Requisition_Details(ByVal InLineNumber As String) As String
        ...
        ssql = ssql & " SELECT   PO_Requisition_Details.TransmissionBy,PO_Requisition_Details.OrderNo, PO_Requisition_Header.[Location],PO_Requisition_Header.ShipDate, PO_Requisition_Header.ArriveDate, PO_Requisition_Header.ShipMethodID  "
        ...
        If dt.Rows.Count <> 0 Then
            ...
            Try
                ...
                If ShipMethodID <> "" Then
                    ...
                    ShipMethodDesc = SETVendorShipMethodDescription(Me.CompanyID, Me.DivisionID, Me.DepartmentID, Location, ShipMethodID)
                End If
    ...
    Public Function GetVendorShipMethodDescription(ByVal CompanyID As String, ByVal DivisionID As String, ByVal DepartmentID As String, ByVal LocationID As String, ByVal ShipMethodID As String) As DataTable

        Dim dt As New DataTable

        Using Connection As New SqlConnection(ConfigurationManager.AppSettings("ConnectionString"))
            Using Command As New SqlCommand("[enterprise].[GetVendorShipMethodDescription]", Connection)
    ...
    Public Function SETVendorShipMethodDescription(ByVal CompanyID As String, ByVal DivisionID As String, ByVal DepartmentID As String, ByVal LocationID As String, ByVal ShipMethodID As String) As String
        Dim ShipMethodDescription As String = ""
        Dim dtShipMethod As New DataTable
        dtShipMethod = GetVendorShipMethodDescription(CompanyID, DivisionID, DepartmentID, LocationID, ShipMethodID)
        If dtShipMethod.Rows.Count <> 0 Then
            ShipMethodDescription = dtShipMethod.Rows(0)(0).ToString()
        End If

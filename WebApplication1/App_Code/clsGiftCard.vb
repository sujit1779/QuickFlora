...
Public Class clsGiftCard
    ...
    Public Function GenerateRandomAuthKey(length As Int16) As String
    ...
    Public Function GetGiftCardList(CompanyID As String, DivisionID As String, DepartmentID As String, Optional GiftCardNumber As String = "") As DataTable
    ...
    Public Function GetGiftCardItemsList(CompanyID As String, DivisionID As String, DepartmentID As String, Optional GiftCardItemID As String = "") As DataTable
    ...
    Public Function CreateGiftCard(CompanyID As String, DivisionID As String, DepartmentID As String, GiftCardNumber As String, _
                                        GiftCardItemID As String, Amount As String, LocationID As String, AuthKey As String) As String
        'Public Function CreateGiftCard(CompanyID As String, DivisionID As String, DepartmentID As String, GiftCardNumber As String, _
    ...
    Public Function SuspendGiftCard(CompanyID As String, DivisionID As String, DepartmentID As String, GiftCardNumber As String) As String
    ...
    Public Function UpdateGiftCard(CompanyID As String, DivisionID As String, DepartmentID As String, GiftCardNumber As String, _
                                            Suspend As Boolean, Active As Boolean) As Boolean
    ...
    Public Function CheckGiftCardBalanceAmount(CompanyID As String, DivisionID As String, DepartmentID As String, GiftCardNumber As String, AuthKey As String, ByRef BalanceAmount As String) As String
    ...
    Private Function GenerateForgetGiftCardTemporaryKey(CompanyID As String, DivisionID As String, DepartmentID As String, GiftCardNumber As String, _
                                                        ByRef CustomerName As String, CustomerEmail As String, TemporaryAuthKey As String) As String
    ...
    Public Function ForgetGiftCardAuthKey(CompanyID As String, DivisionID As String, DepartmentID As String, GiftCardNumber As String, CustomerEmail As String) As String
    ...
    Private Function SendForgetAuthKeyEmail(CompanyID As String, DivisionID As String, DepartmentID As String, GiftCardNumber As String, _
                                           CompanyName As String, CompanyEmail As String, CompanyPhone As String, CompanyAddress As String, CompanyFrontEndURL As String, _
                                           CustomerName As String, CustomerEmail As String, NewAuthKey As String) As Boolean
    ...
    Public Function UpdateGiftCardAuthKey(CompanyID As String, DivisionID As String, DepartmentID As String, _
                                          GiftCardNumber As String, CustomerEmail As String, NewAuthKey As String, TemporaryAuthKey As String) As String
    ...
    Public Function SendGiftCardBookingEmail(CompanyID As String, DivisionID As String, DepartmentID As String, OrderNumber As String, _
                                             GiftCardNumber As String, AuthKey As String, Amount As String, IssueDate As String, ExpirytDate As String, _
                                             CustomerID As String, CustomerName As String, CustomerEmail As String) As Boolean
    ...
    Public Function EmailSending(CompanyID As String, DivisionID As String, DepartmentID As String, _
    ...
    Public Sub NewEmailSending(CompanyID As String, DivisionID As String, DepartmentID As String, ByVal Email As MailMessage)

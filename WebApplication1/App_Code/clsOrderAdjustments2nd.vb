...
Public Class clsOrderAdjustments2nd
    ...
    Public Function UpdateOrderAdjustmentsApprovalNumber() As Boolean
        ...
        Dim connec As New SqlConnection(constr)
        Dim qry As String
        qry = "UPDATE [Enterprise].[dbo].[OrderHeaderCreditCardProcessingDetails2nd] set PPIOrderID=@f5,PPIReferenceID=@f6,PayPalPNREF=@f7,ProcessDate=@f8,PaymentAmount=@f9 Where CompanyID=@f1 and DivisionID=@f2 and DepartmentID=@f3 and OrderNumber=@f4 "
        Dim com As SqlCommand
        com = New SqlCommand(qry, connec)
        Try
            com.Parameters.Add(New SqlParameter("@f1", SqlDbType.NVarChar, 36)).Value = Me.CompanyID
    ...
    Public Function DeleteOrderAdjustmentsApprovalNumber() As Boolean
        ...
        Dim connec As New SqlConnection(constr)
        Dim qry As String
        qry = "Delete from OrderHeaderCreditCardProcessingDetails2nd Where CompanyID=@f1 and DivisionID=@f2 and DepartmentID=@f3 and OrderNumber=@f4 "
        Dim com As SqlCommand
        com = New SqlCommand(qry, connec)
        Try
            com.Parameters.Add(New SqlParameter("@f1", SqlDbType.NVarChar, 36)).Value = Me.CompanyID
    ...
    Public RefundAmount As Decimal = 0

    Public Function InsertCreditCardPaymentDetails() As Boolean

        Dim connec As New SqlConnection(constr)
        Dim qry As String
        qry = "INSERT INTO  OrderHeaderCreditCardProcessingDetails2nd (CompanyID,DivisionID,DepartmentID,OrderNumber,PaymentGateway,PPIOrderID,PPIReferenceID,PayPalPNREF,PaymentAmount,CreditCardNumber,CreditCardExpDate,CreditCardCSVNumber,[RefundAmount],[ChargeTypes] ,[ChargeStatus] ) values(@f1,@f2,@f3,@f4,@f5,@f6,@f7,@f8,@f9,@f10,@f11,@f12,@f13,@f14,@f15)"
        Dim com As SqlCommand
        com = New SqlCommand(qry, connec)
        Try
            com.Parameters.Add(New SqlParameter("@f1", SqlDbType.NVarChar, 36)).Value = Me.CompanyID
            ...
            com.Parameters.Add(New SqlParameter("@f13", SqlDbType.Money)).Value = Me.RefundAmount

            com.Parameters.Add(New SqlParameter("@f14", SqlDbType.NVarChar, 36)).Value = ChargeTypes
            com.Parameters.Add(New SqlParameter("@f15", SqlDbType.NVarChar, 36)).Value = ChargeStatus
    ...
    Public Function UpdateCreditCardPaymentNewCardDetails() As Boolean
        ...
        Dim connec As New SqlConnection(constr)
        Dim qry As String
        qry = "UPDATE  OrderHeaderCreditCardProcessingDetails2nd SET  CreditCardNumber=@f10,CreditCardExpDate=@f11,CreditCardCSVNumber=@f12 where CompanyID=@f1 and DivisionID=@f2 and DepartmentID=@f3 and OrderNumber=@f4"
        Dim com As SqlCommand
        com = New SqlCommand(qry, connec)
        Try
            com.Parameters.Add(New SqlParameter("@f1", SqlDbType.NVarChar, 36)).Value = Me.CompanyID
    ...
    Public ChargeTypes As String = ""
    Public ChargeStatus As String = ""

    Public Function UpdateCreditCardPaymentChargeType(ByVal ChargeTypes As String, ByVal ChargeStatus As String) As Boolean

        Dim connec As New SqlConnection(constr)
        Dim qry As String
        qry = "UPDATE  OrderHeaderCreditCardProcessingDetails2nd SET  [ChargeTypes]=@f5,[ChargeStatus]=@f6 where CompanyID=@f1 and DivisionID=@f2 and DepartmentID=@f3 and OrderNumber=@f4"
        Dim com As SqlCommand
        com = New SqlCommand(qry, connec)
        Try
            com.Parameters.Add(New SqlParameter("@f1", SqlDbType.NVarChar, 36)).Value = Me.CompanyID
    ...
    Public Function UpdateCreditCardPaymentRefundAmount(ByVal inlinenumber As Integer) As Boolean

        Dim connec As New SqlConnection(constr)
        Dim qry As String
        qry = "UPDATE  OrderHeaderCreditCardProcessingDetails2nd SET [RefundAmount]=@f6 where CompanyID=@f1 and DivisionID=@f2 and DepartmentID=@f3 and OrderNumber=@f4  and [InLIneNUmber]=@f5"
        Dim com As SqlCommand
        com = New SqlCommand(qry, connec)
        Try
            com.Parameters.Add(New SqlParameter("@f1", SqlDbType.NVarChar, 36)).Value = Me.CompanyID
            ...
            com.Parameters.Add(New SqlParameter("@f3", SqlDbType.NVarChar, 36)).Value = Me.DepartmentID
            com.Parameters.Add(New SqlParameter("@f4", SqlDbType.NVarChar, 36)).Value = Me.OrderNumber
            com.Parameters.Add(New SqlParameter("@f5", SqlDbType.BigInt)).Value = inlinenumber
            com.Parameters.Add(New SqlParameter("@f6", SqlDbType.Money)).Value = Me.RefundAmount
    ...
    Public Function DetailsCreditCardPaymentDetails() As DataTable
        ...
        Dim ssql As String = ""
        Dim dt As New DataTable()
        ssql = "select * from OrderHeaderCreditCardProcessingDetails2nd where CompanyID=@f0 and DivisionID=@f1 and DepartmentID=@f2 and OrderNumber=@f3"
        Dim da As New SqlDataAdapter
        Dim com As SqlCommand
        com = New SqlCommand(ssql, connec)
        Try
    ...
    Public Function DetailsCreditCardPaymentDetailsinlinenumber(ByVal inlinenumber As Integer) As DataTable
        Dim connec As New SqlConnection(constr)
        Dim ssql As String = ""
        Dim dt As New DataTable()
        ssql = "select * from OrderHeaderCreditCardProcessingDetails2nd where CompanyID=@f0 and DivisionID=@f1 and DepartmentID=@f2 and [InLIneNUmber]=@f3"
        Dim da As New SqlDataAdapter
        Dim com As SqlCommand
        com = New SqlCommand(ssql, connec)
        Try
    ...
    Public Function DetailsCreditCardPaymentSalesDetails() As DataTable
        Dim connec As New SqlConnection(constr)
        Dim ssql As String = ""
        Dim dt As New DataTable()
        ssql = "select * from OrderHeaderCreditCardProcessingDetails2nd where Lower([ChargeTypes]) ='sale' and (isnull([PaymentAmount],0) - isnull([RefundAmount],0)) > 0 and CompanyID=@f0 and DivisionID=@f1 and DepartmentID=@f2 and OrderNumber=@f3   order by [InLIneNUmber] desc"
        Dim da As New SqlDataAdapter
        Dim com As SqlCommand
        com = New SqlCommand(ssql, connec)
        Try

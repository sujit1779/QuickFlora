...
Public Class clsCreditCardChargeOnRebook
    ...
    Public Function ChrageCreditCard() As String
        ...
        ds = PostOrder.CheckCreditCardOffline(CompanyID, DepartmentID, DivisionID, PMG)
    ...
    Public Function PaymentDetailsPPIRefundBeforeAditionalcharge(ByVal OrdNumber As String, ByVal dtpayment As DataTable) As String
        ...
        subject = "Adjustment Details Processing details Used"
        mailcontent = mailcontent & "obj.chargeTotal  =" & obj.chargeTotal & " "
        mailcontent = mailcontent & "obj.chargeType  =" & obj.chargeType & " "
        mailcontent = mailcontent & "obj.orderID  =" & obj.orderID & " "
        mailcontent = mailcontent & "obj.referenceID  =" & obj.referenceID & " "
        mailcontent = mailcontent & "obj.transactionConditionCode  =" & obj.transactionConditionCode & " "

<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="CreateRequisition.aspx.vb" Inherits="CreateRequisition" %>
...
//                return 0;
         ...
         function myFocusFunctiontotalnew(id0, RowNumber, id1, id3) {
            ...
            document.getElementById(id0).value = (Qty * Cost).toFixed(2);
            ...
            //Saveitemnew(id0, RowNumber, "Ext_COSt", 0);
            Saveitemnew(id1, RowNumber, "Q_REQ", 0);
            Saveitemnew(id3, RowNumber, "WHOPrice", 0);
        ...
        function SendQuery2(key, This, RowNumber, txtPACK_ClientID, txtCOST_ClientID, txtVendor_Code,txtUOM,txtWHOPrice) {
            //alert(This.id);
            //alert(RowNumber);
            ...
            Initialize();
            var url = "AjaxItemsSearchNewpage.aspx?k=" + key + "&id=" + This.id + "&RowNumber=" + RowNumber + "&txtPACK_ClientID=" + txtPACK_ClientID + "&txtCOST_ClientID=" + txtCOST_ClientID + "&txtVendor_Code=" + txtVendor_Code +"&txtUOM=" + txtUOM + "&txtWHOPrice=" + txtWHOPrice;
             // alert(url);
        ...
        function FillSearchtextBoxnew(val, ID, DIVID, val1, val2, id1, id2, nm, VendorID , txtVendor_Code,txtUOM,txtUOMVL,txtWHOPrice,txtWHOPriceVL) {
            // alert(val);
            document.getElementById(ID).value = val;
            ...
            //alert(VendorID);
            //alert(document.getElementById(txtVendor_Code));
           // document.getElementById(txtVendor_Code).value = VendorID;

            //alert(txtUOMVL);
            //alert(document.getElementById(txtUOM));
            document.getElementById(txtUOM).value = txtUOMVL;

            //alert(txtWHOPriceVL);
            //alert(document.getElementById(txtWHOPrice));
            document.getElementById(txtWHOPrice).value = txtWHOPriceVL;
            document.getElementById("autocomplete" + DIVID).innerHTML = "";
            document.getElementById(ID).focus();
            document.getElementById(ID).click();
            HideDiv("autocomplete" + DIVID);
            ...
            <div class="portlet-body">
                ...
                <asp:GridView ID="OrderHeaderGrid" ShowHeaderWhenEmpty="true" AllowSorting="True" runat="server" DataKeyNames="InLineNumber" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="false" AllowPaging="True" PageSize="25">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Product">
                          ...
                          <asp:TemplateField HeaderText="UOM">
                            <ItemTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtUOM" Text='<%#Eval("UOM")%>' Width="100px" runat="server"></asp:TextBox>
                            </ItemTemplate>
                     ...
                     <asp:TemplateField HeaderText="Price">
                            <ItemTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtWHOPrice" Text='<%#Eval("WHOPrice")%>' Width="70px" runat="server"></asp:TextBox>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Qty. Req.">
                            <ItemTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtQ_REQ" Text='<%#Eval("Q_REQ")%>' Width="60px" runat="server"></asp:TextBox>
                            </ItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="Total">
                            <ItemTemplate>
                                <asp:TextBox CssClass="form-control input-sm" ID="txtQ_REQTotal" Text='' Width="80px" runat="server"></asp:TextBox>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Status">
                            <ItemTemplate>
                                <asp:Label   ID="txtStatus" ReadOnly="True" Text='<%#Eval("Status")%>' Width="140px" runat="server"></asp:Label>
                                <asp:DropDownList ID="drpPOStatus" CssClass="form-control input-sm" Visible="false" Width="140px" runat="server">

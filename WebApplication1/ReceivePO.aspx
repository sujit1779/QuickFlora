<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false"
    CodeFile="ReceivePO.aspx.vb" Inherits="ReceivePO" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Updateitem(key, saveid) {
            Initialize();
            var url = "AjaxItemsReceivePOUpdate.aspx?POReceivedDate=" + document.getElementById("ctl00_ContentPlaceHolder_txtArrivalDate").value + "&LocationID=" + document.getElementById("ctl00_ContentPlaceHolder_drpShiplocation").value + "&" + key;
                    ...
                    <div class="form-body">
                        <table id="table3" class="table table-striped table-hover table-bordered">
                            <tr id="trtop" runat="server" visible="false">
                                ...
                                <td width="101" style="background-color: #F6F6F6;" height="12">
                                    <Ajax:AjaxPanel ID="AjaxPanel1" runat="server">
                                        <asp:Label Width="95" BorderWidth="1px" BorderColor="#939393" ID='lblrefersh' CssClass="txtStyle"
                                            Height="18" runat="server" Text=''></asp:Label>
                                    </Ajax:AjaxPanel>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="101" height="12">
                                    <Ajax:AjaxPanel ID="AjaxPanel2" runat="server">
                                        <asp:Label Width="95" ID='lblPurchaseOrderNumberData' Height="18" runat="server"
                                            Text='(New)'></asp:Label>
                                    </Ajax:AjaxPanel>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="101" height="15">
                                    <Ajax:AjaxPanel ID="AjaxPanel270" runat="server">
                                        <asp:DropDownList CssClass="form-control input-xs" ID="drpPurchaseTransaction" runat="server"
                                            TabIndex="2">
                            ...
                            <tr>
                                ...
                                <td width="101" height="15">
                                    <Ajax:AjaxPanel ID="AjaxPanel2710" runat="server">
                                        <asp:DropDownList ID="cmblocationid" CssClass="form-control input-xs" runat="server"
                                            TabIndex="4">
                                        </asp:DropDownList>
                                    </Ajax:AjaxPanel>
                                </td>
                            ...
                            <tr>
                                ...
                                <td width="101" height="15">
                                 <ajax:ajaxpanel id="AjaxPanel5" runat="server">
                                     ...
                                     <asp:TextBox ID="invoiveno" CssClass="form-control input-sm"   runat="server"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td width="101" height="15">
                                 <ajax:ajaxpanel id="AjaxPanel11" runat="server">
                                     ...
                                     <asp:TextBox ID="MABWNO" CssClass="form-control input-sm"   runat="server"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td width="101" height="15">
                                    <asp:DropDownList CssClass="form-control input-xs" ID="drpReceiveby" AppendDataBoundItems="true"
            ...
            <div class="row">
                <div class="col-md-12" style="padding-top: 10px;">
                    <Ajax:AjaxPanel ID="AjaxPanel7" runat="server">
                        &nbsp;<asp:ImageButton ID="btncustsearch" ToolTip="Update Customer" ImageUrl="~/images/2-sh-stock-in.gif"
                            Width="0" runat="server" />
                    ...
                    <div class="col-md-5">
                        <Ajax:AjaxPanel ID="AjaxPanel10" runat="server">
                            <div id="pnlPricerange" runat="server" class="text-center">
                                <asp:Label ID="lblPricerange" BackColor="#40BD24" ForeColor="white" Font-Bold="true"
                                    runat="server" Text=""></asp:Label>
                                <asp:Label ID="lblInventoryStatus" BackColor="#40BD24" ForeColor="red" Font-Bold="true"
                                    runat="server" Text=""></asp:Label>
                            </div>
                        </Ajax:AjaxPanel>
                    </div>
        ...
        <div class="portlet-body form">
            <div class="form-group-search-block">
                <div class="input-group">
                    ...
                    <br />
                    <div align="left" class="box autocomplete" style="visibility: hidden;" id="autocomplete2">
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="text-center">
                                            ID
                                            <asp:TextBox ID="txtitemid" ReadOnly="true" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="text-center">
                                            Name
                                            <asp:TextBox ID="txtitemsearchDesc" ReadOnly="true" CssClass="form-control input-sm"
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-center">
                                            Desc
                                            <asp:TextBox ID="txtDesc" ReadOnly="true" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-center">
                                            Comments
                                            <asp:TextBox ID="txtComments" ReadOnly="true" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-1">
                                        <div class="text-center">
                                            Qty<br />
                                            <asp:TextBox ID="txtQty" ReadOnly="true" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="text-center">
                                            UOM<br />
                                            <asp:TextBox ID="txtuom" ReadOnly="true" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="text-center">
                                            Pack<br />
                                            <asp:TextBox ID="txtPack" ReadOnly="true" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="text-center">
                                            Units<br />
                                            <asp:TextBox ID="txtunits" ReadOnly="true" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="text-center">
                                            Received Qty
                                            <asp:TextBox ID="RQty" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                                            <asp:HiddenField ID="prevReceived" runat="server" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="text-center">
                                            Received Pack
                                            <asp:TextBox ID="RPack" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="text-center">
                                            Received Units
                                            <asp:TextBox ID="RUnits" CssClass="form-control input-sm" runat="server" ReadOnly="true"></asp:TextBox>
                                            <asp:HiddenField ID="prevRUnits" runat="server" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <Ajax:AjaxPanel ID="AjaxPanel13" runat="server">
                        <asp:ImageButton ID="ImgUpdateSearchitems" OnClientClick="javascript:FillSearchtextBox22();"
                            ToolTip="Update Item" ImageUrl="~/images/2-sh-stock-in.gif" Width="0" runat="server" />
            ...
            <div id="dvitems" class="row">
                <div class="col-md-12">
                    <div style="width: 98%" class="text-right">
                        <asp:Button ID="btnpost" OnClientClick="return checksubmit();" CausesValidation="false"
                            CssClass="btn btn-success btn-xs" runat="server" Text="Receive All" Width="150">
                        </asp:Button>
                    </div>

                    <table class="table table-striped table-hover table-bordered dataTable tableRecord"
            ...
            <div style="display: none">
                <Ajax:AjaxPanel ID="AjaxPanel104" runat="server">
                    ...
                    <asp:TextBox ID="txtOrderNumber" Width="200px" Font-Size="12" Text="" Height="28"
                        runat="server"></asp:TextBox>
                </Ajax:AjaxPanel>
            </div>
                                ...
                                <Ajax:AjaxPanel ID="AjaxPanel19" runat="server">
                                    <table class="table table-striped table-hover table-bordered">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList CssClass="form-control input-xs" ID="drpShiplocation" AutoPostBack="true"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="form-control input-sm" ID="txtLCAddress" runat="server" Text=''></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="table table-striped table-hover table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtLCCity" CssClass="form-control input-sm" runat="server" Text=''></asp:TextBox>
                                                </td>
                                                <td>
                                                    Zip/Postal
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtLCZip" runat="server" CssClass="form-control input-sm" Text=''></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox CssClass="form-control input-sm" ID="txtLCPhone" runat="server" Text=''></asp:TextBox>
                                                </td>
                                                <td>
                                                    Fax
                                                </td>
                                                <td>
                                                    <asp:TextBox CssClass="form-control input-sm" ID="txtLCFax" runat="server" Text=''></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td colspan="3">
                                                    <asp:TextBox CssClass="form-control input-sm" ID="txtLCEmail" runat="server" Text=''></asp:TextBox>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <Ajax:AjaxPanel ID="AjaxPanel20" runat="server">
                                    <table class="table table-striped table-hover table-bordered">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList CssClass="form-control input-xs" ID="drpShipMethod" runat="server"
                                                    TabIndex="2">
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtArrivalDate" runat="server" CssClass="form-control input-sm date-picker input-200"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                              <td>Occasion Code</td>
                                              <td>
                                                <asp:DropDownList ID="drpOccasionCode" runat="server" CssClass="form-control input-sm"  TabIndex="89" data-tab-priority="27">
                                                  </asp:DropDownList>
                                              </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:TextBox ID="txtInternalNotes" TextMode="MultiLine" Rows="4" CssClass="form-control input-xs"
                                                    runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table table-striped table-hover table-bordered">
                                        <tr>
                                            ...
                                            <td colspan="2" style="width: 50%">
                                                <asp:TextBox ID="txtSubtotal" runat="server" Enabled="True" ReadOnly="True" Text="0.00"
                                                    CssClass="form-control input-xs"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="text-right">
                                            ...
                                            <td colspan="2">
                                                <Ajax:AjaxPanel ID="AjaxPanel35" runat="server">
                                                    <asp:TextBox ID="txtDelivery" CssClass="form-control input-xs" runat="server" Text="0.00"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <Ajax:AjaxPanel ID="AjaxPanel38" runat="server">
                                                                <asp:DropDownList AutoPostBack="true" CssClass="form-control input-xs" ID="drpTaxes"
                                                                    runat="server">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtTaxPercent" CssClass="form-control input-xs" runat="server" ReadOnly="True"
                                                                Text="6.00" Enabled="True" Width="50"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td colspan="2">
                                                <asp:TextBox ID="txtTax" CssClass="form-control input-xs" runat="server" ReadOnly="True"
                                        ...
                                        <tr class="total-foot">
                                            ...
                                            <td colspan="2">
                                                <asp:TextBox ID="txtTotal" CssClass="form-control input-xs" runat="server" ReadOnly="True"
                                                    Text="0.00" Enabled="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                                        ...
                                        <tr>
                                            <td colspan="2" class="text-center">
                                                <asp:Button ID="btnsave" CausesValidation="false" CssClass="btn btn-success btn-xs"
                                                    runat="server" Text="Done" Width="150"></asp:Button>
                                            </td>
                                            <td colspan="2" class="text-center">
                                                <a id="Button1" class="btn btn-danger btn-xs" href="ReceivePOList.aspx">Back</a>
                                            </td>
                                        </tr>
                                    </table>
                                </Ajax:AjaxPanel>
            ...
            <div class="row">
                <div class="col-md-4">
                    <table class="table table-striped table-hover table-bordered">
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkPosted" runat="server" Enabled="False"></asp:CheckBox>
                            </td>
                            <td>
                                Posted
                            </td>
                            <td>
                                <asp:TextBox ID="txtPostedDate" runat="server" ReadOnly="false" Text='' CssClass="form-control input-xs"
                            ...
                            <td>
                                <asp:TextBox ID="txtPostedTime" runat="server" ReadOnly="false" CssClass="form-control input-xs"
                        ...
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkPrint" runat="server" Enabled="False"></asp:CheckBox>
                            </td>
                            <td>
                                Print
                            </td>
                            <td>
                                <asp:TextBox ID="txtPrintDate" runat="server" ReadOnly="false" Text='' CssClass="form-control input-xs"
                                    TabIndex="94"></asp:TextBox>
                            </td>
                            <td>
                                Date
                            ...
                            <td>
                                <asp:TextBox ID="txtPrintTime" runat="server" ReadOnly="false" CssClass="form-control input-xs"
                                    TabIndex="95"></asp:TextBox>
                            </td>
                            <td>
                                Time
                ...
                <div class="col-md-4">
                    <table class="table table-striped table-hover table-bordered">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtApprovedDate" runat="server" ReadOnly="false" CssClass="form-control input-xs"
                                    Text=''></asp:TextBox>
                            </td>
                            <td>
                                Date
                            ...
                            <td>
                                <asp:TextBox ID="txtApprovedTime" runat="server" ReadOnly="false" CssClass="form-control input-xs"></asp:TextBox>
                            </td>
                            <td>
                                Time
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtSentDate" runat="server" ReadOnly="false" CssClass="form-control input-xs"
                                    Text=''></asp:TextBox>
                            </td>
                            <td>
                                Date
                            ...
                            <td>
                                <asp:TextBox ID="txtSentTime" runat="server" ReadOnly="false" CssClass="form-control input-xs"></asp:TextBox>
                            </td>
                            <td>
                                Time
                            </td>
                ...
                <div class="col-md-4">
                    <table class="table table-striped table-hover table-bordered">
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkReceived" runat="server" Enabled="False" />
                            </td>
                            <td>
                                Received
                            </td>
                            <td>
                                <asp:TextBox ID="txtReceivedDate" runat="server" ReadOnly="false" CssClass="form-control input-xs"
                                    Text=''></asp:TextBox>
                            </td>
                            <td>
                                Date
                            ...
                            <td>
                                <asp:TextBox ID="txtReceivedTime" runat="server" ReadOnly="false" CssClass="form-control input-xs"></asp:TextBox>
                            </td>
                            <td>
                                Time
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkShipped" runat="server" Enabled="False" />
                            </td>
                            <td>
                                Shipped
                            </td>
                            <td>
                                <asp:TextBox ID="txtShippedDate" runat="server" CssClass="form-control input-xs"
                            ...
                            <td>
                                <asp:TextBox ID="txtShippedTime" runat="server" CssClass="form-control input-xs"
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <script type="text/javascript" src="assets/scripts/table-editable2.js?k=9"></script>
    <script type="text/javascript">

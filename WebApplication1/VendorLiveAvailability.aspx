<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" Debug="true" AutoEventWireup="false" CodeFile="VendorLiveAvailability.aspx.vb" Inherits="VendorLiveAvailability" %>
               ...
               <table width="100%" >
                ...
                <asp:GridView ID="gvItemsList" runat="server" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Vendor" HeaderStyle-HorizontalAlign="Left" DataField="Location"   />

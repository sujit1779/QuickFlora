<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false" CodeFile="OrderListWH.aspx.vb" Inherits="OrderList" %>
...
<script type="text/javascript" language="javascript">
  ...
  <ajax:AjaxPanel id="AjaxPanel3" runat="server">
                                                     ...
                                                     <table>
                                                        <tr>
                                                            ...
                                                            <td><asp:RadioButton ID="rdDeliveryDates"  GroupName="Dates" Text="Arrival Date"   runat="server" /></td>
                                                             <td>&nbsp;</td>
                                                            <td><asp:RadioButton ID="rdShipDates"  GroupName="Dates" Text="Ship Date"   runat="server" /></td>
                                                             <td>&nbsp;</td>
                                                            <td> <asp:Button ID="btnsearch1" runat="server" CssClass="btn btn-success btn-xs" Text="Search" /> </td>
                                                        </tr>
     ...
     <div id="divEmailContent" visible="false"   runat="server"  ></div>
 ...
 <asp:GridView ID="OrderHeaderGrid" AllowSorting="True" runat="server" DataKeyNames="PurchaseNumber"  CssClass="table table-bordered table-striped table-condensed flip-content"     AutoGenerateColumns="false" AllowPaging="True" PageSize="200">
            ...
            <Columns>
                ...
                <ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="PO #" SortExpression="PurchaseNumber">
                    <ItemTemplate>
                       ...
                       </asp:Label> <asp:Label ID="lblOrderNumber" Text='<%#Eval("PurchaseNumber")%>' runat="server"></asp:Label>
                    </ItemTemplate>
                    ...
                    <ItemTemplate>
                        <asp:ImageButton ID="imgWorkTicketPrint" 
                            CommandName="POPrint" CommandArgument='<%# Eval("PurchaseNumber") %>' ToolTip="Print PO"
                     ...
                     <asp:TemplateField HeaderText="Email"  ItemStyle-VerticalAlign="Middle">
                        <ItemTemplate>
                            <a  class="btn btn-warning btn-xs tooltips" href='emailtovendor.aspx?PurchaseNumber=<%# Eval("PurchaseNumber")%>'>
                 ...
                 <asp:TemplateField HeaderText="Dup"  ItemStyle-VerticalAlign="Middle">
                        <ItemTemplate>
                            <a  class="btn btn-warning btn-xs tooltips" href='DuplicatePO.aspx?PurchaseOrderNumber=<%# Eval("PurchaseNumber")%>'>
                ...
                <asp:TemplateField HeaderText="Arrival .Date" SortExpression="OrderShipDate">
                    <ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="Ship Date"  >
                    <ItemTemplate>
					    <asp:Label ID="lblShip" Text='<%#Eval("ShipDate") %>' runat="server"></asp:Label>
				    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Tran. Type"  SortExpression="Transaction Type">
                    <ItemTemplate>
					    <%#Eval("TransactionTypeID")%>
				    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="MAWB No" >
                   ...
                   <asp:TemplateField HeaderText="Status" Visible="false"    >
                    <ItemTemplate>
                        <asp:Label ID="lblstatus" Text='<%#Eval("OrderStatus")%>' runat="server"></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Bought" Visible="false"   >
                    <ItemTemplate>
                        <asp:Label ID="lblacknowledged" Text='<%#Eval("acknowledged")%>' runat="server"></asp:Label>
				    </ItemTemplate>
                </asp:TemplateField>
                
                 <asp:TemplateField HeaderText="Cancel PO">
                    <ItemTemplate>
                        <asp:ImageButton ID="imgCancel" CommandArgument='<%# Eval("PurchaseNumber") %>'  
                            OnClientClick="return confirm('Alert! You are about to cancel PO. \n If you wish to continue, press OK.');"
                ...
                <asp:TemplateField HeaderText="Finalize">
                    <ItemTemplate>
                        ...
                        <button type="button" onclick='return confirm("Are sure you want to finalize this PO?") ? finalize(this,"<%# Eval("PurchaseNumber") %>") : ""' class="btn btn-xs btn-success">Finalize</button>
                            </asp:Label>
				    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
...
<script>
    ...
    function finalize(el,po) {
        ...
        $.ajax({
            method: 'Post',
            url: `https://secureapps.quickflora.com/V2/api/FinalizePO`,
            dataType: 'json',
            headers: {

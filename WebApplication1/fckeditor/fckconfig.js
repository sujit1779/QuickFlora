...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','Bold', 'Italic', 'Underline', 'StrikeThrough', '-', 'OrderedList', 'UnorderedList', '-', 'Style', 'FontFormat'],
    ['FontName', 'FontSize', '-', 'TextColor', 'BGColor', '-', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyFull', '-', 'Preview', 'SelectAll', 'RemoveFormat']] ;

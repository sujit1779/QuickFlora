<%@ Page Title="" Language="VB" MasterPageFile="~/MainMasterInv.master" AutoEventWireup="false" CodeFile="RequisitionBid.aspx.vb" Inherits="RequisitionBid" %>
...
<script type="text/javascript" src="https://secure.quickflora.com/Admin/EnterpriseASPAR/CustomOrder/codebase/dhtmlxcalendar.js"></script>
    ...
    function itemsearchBlurProcess() {
        ...
        function Saveitem(This, ItemID, VendorID,LocationID,ShipDate, name, oldvalue) {
            Initialize();
            //alert(This.value);
            This.style.backgroundColor = "";

            var url = "AjaxsaveRObid.aspx?VendorID=" + VendorID + "&LocationID=" + LocationID + "&ShipDate=" + ShipDate + "&ItemID=" + ItemID + "&value=" + This.value + "&name=" + name;
            // alert(url);
            //alert(This.value);
            //alert(oldvalue);
               ...
               <table   >
                    ...
                    <tr  >
                            <td><b></b> </td> <td align=left>
                             <table>
                                   <tr>
                            <td style="padding-left:50px;"><b>&nbsp;&nbsp;Ship Date&nbsp;&nbsp;</b> </td> <td align=left>
            ...
            <div style='z-index: 90; height: 100%' class="table-responsive">
                ...
                <asp:GridView ID="gvItemsList" runat="server" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Category" Visible="false"    HeaderStyle-HorizontalAlign="Left" DataField="ItemCategoryID"   />
                        ...
                        <asp:BoundField HeaderText="UOM" HeaderStyle-HorizontalAlign="Left" DataField="UOM"   />
                         <asp:TemplateField   HeaderText="Ship Date">
                            <ItemTemplate>
                                <asp:label ID="lblShipDate" Text='<%#Eval("ShipDate")%>'    runat="server"></asp:label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Vendor Bid Qty">
                            <ItemTemplate>
                                <asp:TextBox ID="txtVendorBidQty" Text=''  Width="100"  CssClass="form-control input-sm" runat="server"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Vendor Bid Price">
                            <ItemTemplate>
                                <asp:TextBox ID="txtVendorBidPrice"  Text='' Width="100" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        </asp:TemplateField>

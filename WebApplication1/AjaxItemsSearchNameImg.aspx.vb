...
Partial Class AjaxItemsSearchNameImg
        ...
        If Not Request.QueryString("k") = Nothing Then
            ...
            If keyword <> "" Then
                ...
                If dt.Rows.Count = 1 Then
                    ...
                    'ThumbnailImage
                    Try
                        str = str & "~!" & returl(dt.Rows(0)("ThumbnailImage"))
                    Catch ex As Exception
                        str = str & "~!" & returl("noimagenew.png")
                    End Try
    ...
    Private Function ExactInventoryItemSearch(ByVal keyword As String) As DataTable
        ...
        sql = sql & " select  InventoryItems.ItemName,InventoryItems.Price,wholesalePrice,UnitsPerBox ,VendorID  ,ISNULL(ThumbnailImage ,'noimagenew.png') AS ThumbnailImage "

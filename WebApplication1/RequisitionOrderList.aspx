<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false" CodeFile="RequisitionOrderList.aspx.vb" Inherits="RequisitionOrderList" %>
    ...
    <ajax:AjaxPanel ID="AjaxPanel101" runat="server">
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body">
                        ...
                        <div class="col-md-4">
                            <div class="row form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    &nbsp;&nbsp;<asp:CheckBox ID="chkincludeStanding" AutoPostBack="true" Text="&nbsp;Include Standing Requests" runat="server" />
                                    ...
                                    <div class="col-xs-4 col-md-2">
                                    		<div class="form-group">
                                                ...
                                                <asp:DropDownList ID="drpFieldName"  CssClass="form-control input-sm select2me" runat="server">
                                                        <asp:ListItem Value="OrderBy">Order By</asp:ListItem>
                ...
                &nbsp;&nbsp;<asp:CheckBox ID="chkIncludeCanceled" AutoPostBack="true" Text="&nbsp;Include Canceled" runat="server" />
                &nbsp;&nbsp;<asp:CheckBox ID="chkIncludeReceived" AutoPostBack="true" Text="&nbsp;Include Received" runat="server" /> 

                 
                &nbsp;&nbsp;<asp:CheckBox   AutoPostBack="true" ID="rdOnlyCanceled" Text="&nbsp;Only Canceled" runat="server" />
                &nbsp;&nbsp;<asp:CheckBox  AutoPostBack="true" ID="rdOnlyReceived" Text="&nbsp;Only Received" runat="server" /> 
                                        </div>
        ...
        <!-- END PORTLET-->
                ...
                <asp:GridView ID="OrderHeaderGrid" ShowHeaderWhenEmpty="true" AllowSorting="True" runat="server" DataKeyNames="OrderNo" 
                    ...
                    <Columns>
                      <asp:TemplateField HeaderText="View"  ItemStyle-VerticalAlign="Middle">
                        <ItemTemplate>
                            <a target="_blank" class="btn btn-warning btn-xs tooltips" href='<%=newmenu1%>?CompanyID=<%=CompanyID %>&DivisionID=<%=DivisionID %>&DepartmentID=<%=DepartmentID %>&PurchaseNumber=<%# Eval("OrderNo")%>'>
                        ...
                        <asp:TemplateField HeaderText="Edit" SortExpression="OrderNo" >
                            <ItemTemplate>
                                 <asp:Panel ID="Panel1" runat="server"> <a href='<%=newmenu %>?OrderNo=<%#Eval("OrderNo")%>' ><%#Eval("OrderNo")%></a></asp:Panel> 
                         ...
                         <asp:TemplateField HeaderText="Dup">
                    <ItemTemplate>
                        <asp:ImageButton ID="Duplicate"   
                            ToolTip="Duplicate" ImageUrl="~/images/withdrawl.gif" runat="server"
                             OnClientClick="return confirm('Alert! You are about to Duplicate Requisition. \n If you wish to continue, press OK.');"
                            CommandArgument='<%# Eval("OrderNo") %>' CommandName="Duplicate" />
                    </ItemTemplate>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Order Placed Date" SortExpression="OrderPlacedDate" >
                            <ItemTemplate>
                                <asp:Label  ID="lblOrderPlacedDate" Text='<%#Eval("OrderPlacedDate")%>' runat="server"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Received On Date" SortExpression="ReceivedOnDate" >
                            <ItemTemplate>
                                <%#Eval("ReceivedOnDate")%>
                            </ItemTemplate>
                             
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Received By" SortExpression="ReceivedBy" >
                            <ItemTemplate>
                                <asp:Label  ID="txtReceivedBy" Text='<%#Eval("ReceivedBy")%>' runat="server"></asp:Label>
                            </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Status"   >
                    <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Change History">
                            <ItemTemplate>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="lblfromreq" Text='' runat="server"></asp:Label>
                 ...
                 <asp:TemplateField HeaderText="To Req."   >
                    <ItemTemplate>
                        <asp:Label ID="lbltoreq" Text='' runat="server"></asp:Label>

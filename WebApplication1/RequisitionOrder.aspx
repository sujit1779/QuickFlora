<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="RequisitionOrder.aspx.vb" Inherits="RequisitionOrder" %>
...
//            }
        ...
        function myFocusFunctiontotalnewqreq(idqreq,id0, RowNumber, id1, id2, id3) {
           ...
           // alert(url);
            ...
            $.get(url, function(data, status) {
                ...
                if (str1[0] != "Not Found") {
                    ...
                    Saveitemnew(id2, RowNumber, "PACK", 0);
                    Saveitemnew(id3, RowNumber, "COST", 0);
                    Saveitemnew(id4, RowNumber, "Vendor_Code", 0); 
                    }
            });             
    ...
    <ajax:AjaxPanel ID="AjaxPanel101" runat="server">
            ...
            <div class="portlet-body">
                <div class="row">
                    <div class="col-xs-12" style="text-align:left;">
                        <asp:Label ID="lblmasterlocation" runat="server" Text=""></asp:Label>
                    </div> 
                </div> 
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body">
                ...
                <asp:GridView ID="OrderHeaderGrid" ShowHeaderWhenEmpty="true" AllowSorting="True" runat="server" DataKeyNames="InLineNumber" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="false" AllowPaging="True" PageSize="2000">
                    <Columns>

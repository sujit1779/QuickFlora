<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false" CodeFile="MonthlyReceivingReport.aspx.vb" Inherits="MonthlyReceivingReport" %>
			          ...
			          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td style="height: 40px" colspan="3" align="left">
                                <asp:Label ID="lbReportdate" runat="server"  Visible="false"  Text='From Date : ' CssClass="font11_blue_black_padding" />
                                <asp:TextBox ID="txtDeliveryDate"  Visible="false"  runat="server" Width="101px"></asp:TextBox>&nbsp;
                                <img id="btnCal1" src="https://secure.quickflora.com/Admin/images/calender.gif" style=" display:none; cursor: pointer;"  />
                                &nbsp;&nbsp;
                                <asp:Label ID="Label1" runat="server"  Visible="false"    Text=' To Date : ' CssClass="font11_blue_black_padding" />
                                <asp:TextBox ID="txtDeliveryDateTO"   Visible="false"    runat="server" Width="101px"></asp:TextBox>&nbsp;
                               
                               <b> Select Month </b>
                                 &nbsp;&nbsp; 
                                <asp:DropDownList ID="drpmonth" AutoPostBack="true"  runat="server">
    ...
    <div>
        ...
        <table cellpadding=0 cellspacing=0 style="width:100%;">
            <tr>
                ...
                <td style="width:25%; text-align:center;" ><h3><u> Monthly Receiving Report </u> </h3> </td>
                <td style="width:25%; text-align:center; padding-right:30px;" >&nbsp; <a href="#"   onClick="window.open('MonthlyReceivingReportExcel.aspx','gotFusion','toolbar=1,location=1,directories=0,status=0,menubar=1,scrollbars=1,resizable=1,copyhistory=0,width=800,height=600,left=0,top=0')" ><img  alt="excel" src="https://secure.quickflora.com/images/excel.png" width="50" height="50" border="0" /></a>  </td>

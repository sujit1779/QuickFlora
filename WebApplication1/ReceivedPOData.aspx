<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false" CodeFile="ReceivedPOData.aspx.vb" Inherits="ReceivePOList" %>
                             ...
                             <div class="col-xs-3">
                                       ...
                                       <div   class="col-xs-4">
                                            ...
                                            <asp:DropDownList ID="drpstatus"  CssClass="form-control input-sm"  runat="server"  AppendDataBoundItems="true" AutoPostBack="true" >
                                                 ...
                                                 <asp:ListItem Text="Received" Selected="True"  Value="Received"></asp:ListItem>
            ...
            <Columns>
                ...
                <ItemTemplate>
                   <asp:ImageButton ID="imgEdit"    ToolTip="Edit" ImageUrl="~/Images/edit.gif" runat="server" CommandName="Edit" />
                    ...
                    <asp:TemplateField HeaderText="Issue Transfer"  Visible="false">
                        <ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="Adjust">
                        <ItemTemplate>
                           <a href="AdjustReceivedPO.aspx?PO=<%#Eval("PurchaseNumber")%>" class="btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                        </ItemTemplate>
                     </asp:TemplateField>

<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MainMaster.master" CodeFile="IitemsFamily.aspx.vb" Inherits="IitemsFamily" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="Server">
        <h3 class="page-title">Items Family List </h3>
</asp:Content>
...
return false; 
                        ...
                        <div class="btn-group">
                            <div class="col-md-4">
                                ...
                                <asp:DropDownList ID="drpSearchFor" runat="server" CssClass="form-control input-medium select2me select2-offscreen" data-placeholder="Select..." tabindex="-1">
                                    ...
                                    <asp:ListItem Value="ContentLink" Text="Family Name"></asp:ListItem>
                                </asp:DropDownList>
 ...
 <asp:GridView ID="grdContentList" DataKeyNames="ItemFamilyID"  AutoGenerateColumns="false"  AllowPaging="true" runat="server" 
 CssClass="table table-striped table-hover table-bordered"  PageSize="10">
                ...
                CommandName="Delete" ToolTip="Delete"  ImageUrl="~/images/Delete.gif"  runat="server" />
                 ...
                 <asp:BoundField HeaderText="FamilyID"  DataField="ItemFamilyID" >
                      
                 </asp:BoundField>
            
                 <asp:BoundField HeaderText="Family Name"  DataField="FamilyName" >
                      
                 </asp:BoundField>
                 
                <asp:BoundField HeaderText="Family Description"  DataField="FamilyDescription" >
                      
                 </asp:BoundField>


                <asp:BoundField HeaderText="Family SortOrder"  DataField="SortOrder" >
                      
                 </asp:BoundField>
                
                    <asp:BoundField HeaderText="Is Active"  DataField="EnableItemFamilyID" >

...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not Request.QueryString("txtstart") = Nothing Then
            txtstart = Request.QueryString("txtstart")
        End If
        If Not Request.QueryString("txtend") = Nothing Then
            txtend = Request.QueryString("txtend")
        End If

        Dim txtDateTo As String = ""
        If Not Request.QueryString("date") = Nothing Then
            ' txtDateTo = Request.QueryString("date")
        End If
        ...
        If Not Request.QueryString("k") = Nothing Then
            ...
            If keyword <> "" Then
                ...
                Using connection As New SqlConnection(ConfigurationManager.AppSettings("ConnectionString"))
                    Using Command As New SqlCommand("[enterprise].[GetInventoryItemsListAvailbilityAjaxBetaNewPageAll2023]", connection)
                        ...
                        Command.Parameters.AddWithValue("@startavailabledate", txtstart)
                        Command.Parameters.AddWithValue("@endavailabledate", txtend)
                        Command.Parameters.AddWithValue("@ArrivalDate", txtDateTo)

<%@ Page Title="" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false" CodeFile="OrderList.aspx.vb" Inherits="OrderList" %>
					...
					<div class="portlet box green">
						...
						<div class="portlet-body" >
                             ...
                             <div class="col-xs-2">
                                  ...
                                  <div class="col-xs-2">
                                              Entered By
                                                <asp:DropDownList ID="emp" AutoPostBack="true"    CssClass="form-control input-sm"  runat="server"  >
                                                            <asp:ListItem Text="--Please Select--" Value=""></asp:ListItem>
                                                 </asp:DropDownList> 
                                                </div>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Location" >
                 ...
                 <asp:TemplateField HeaderText="Order #"    >
                    <ItemTemplate>
                        <asp:Label ID="lbl_OrderNumber" Text='<%#Eval("OrderNumber")%>' runat="server"></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Entered By">
                    <ItemTemplate>
                        <asp:Label ID="lbl_emp" Text='<%#Eval("Employee")%>' runat="server"></asp:Label>
                    </ItemTemplate>

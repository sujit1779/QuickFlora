...
Partial Class ExportExcelItems2
    ...
    Public Function GetInventoryItemsList(Optional ByVal p1 As String = "", Optional ByVal p2 As String = "", Optional ByVal p3 As String = "", _
        ...
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("ConnectionString"))
            Using Command As New SqlCommand("[enterprise].[GetInventoryItemsListAvailbilityListBetaNewPage2]", connection)
                ...
                Command.Parameters.AddWithValue("@ArrivalDate", p2)
                Command.Parameters.AddWithValue("@startavailabledate", p3)
                Command.Parameters.AddWithValue("@endavailabledate", p4)

                Command.Parameters.AddWithValue("@ExcludeArrivalDate", p5)
                ',@Condition NVARCHAR (36)=NULL, @fieldName NVARCHAR (36)=NULL, @fieldexpression NVARCHAR (400)=NULL
                Command.Parameters.AddWithValue("@Condition", p6)
                Command.Parameters.AddWithValue("@fieldName", p7)
                Command.Parameters.AddWithValue("@fieldexpression", p8)
